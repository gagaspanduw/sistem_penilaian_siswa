...
<?php 
    ...
    $param = $_GET['nip'];
    $sql = "SELECT * FROM tbl_guru where nip='$param'";
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nip" value="<?php echo $r['nip']; ?>" />
                    </div>
                    <div class="form-group">
...
$no_tlp = $_POST['no_tlp'];
$status  = $_POST['status'];
$insert = mysql_query("UPDATE tbl_guru SET nip='$nip', nama='$nama', jk='$jk', alamat='$alamat', no_tlp='$no_tlp', status='$status' where nip='$param'");
if($insert){
