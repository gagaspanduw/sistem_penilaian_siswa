            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    ...
                    <select class="form-control" name="guru" required="" onchange="javascript:get(this)">
                            <option value ="<?php echo $r['nip']; ?>"><?php echo $r['namaguru']; ?></option>
                    ...
                    <input type="text" name="uas" class="form-control" value="<?php echo $r['nilai_uas'];?>">
                    </div>
                    <div class="form-group">
...
$insert = mysql_query("UPDATE tbl_nilai SET semester='$semester', id_pelajaran='$pelajaran', id_kelas='$kelas', nip='$guru', nis='$nama_siswa', nilai_uts='$uts', nilai_uas='$uas', keterangan='$keterangan' WHERE id_nilai='$param'");
if($insert){
