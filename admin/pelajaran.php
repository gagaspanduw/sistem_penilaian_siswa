...
$insert = mysql_query("INSERT INTO tbl_pelajaran VALUES('', '$nama_pelajaran', '$keterangan')");
if($insert){
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        $no=$posisi+0;
                                            ...
                                            $res = $conn->query("SELECT * FROM tbl_pelajaran");
                                            while($row = $res->fetch_assoc()){
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                    <a class="btn btn-primary btn-circle" href="edit_pelajaran.php?id_pelajaran='.$row['id_pelajaran'].'" onclick="return warn()" title="Edit"><i class="fa fa-edit "></i></a>
                                                    <a class="btn btn-danger btn-circle" href="delete_pelajaran.php?id_pelajaran='.$row['id_pelajaran'].'" onclick="return warn()" title="Hapus"><i class="fa fa-trash-o "></i></a></button>
                                                    </td>
                                                </tr>
                                                ';
                                            }
